							...
							<ul class="dropdown-menu dropdown-user">
								<li>
									<div class="user-box">
										...
										<div class="u-text">
											<h4>Rahmadi</h4>
											<p class="text-muted">rahmadi@gmail.com</p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a></div>
										</div>
									</li>
...
<!-- 									<a class="dropdown-item" href="#"></i> My Balance</a>
 -->									<!-- <a class="dropdown-item" href="#"><i class="ti-email"></i> Inbox</a> -->
									...
									<div class="dropdown-divider"></div>
									<a class="dropdown-item" href="#"><i class="fa fa-power-off"></i>Keluar</a>
								</ul>
								<!-- /.dropdown-user -->
							</li>
						</ul>
